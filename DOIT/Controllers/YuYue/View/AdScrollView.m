...
- (void)setImageNameArray:(NSArray *)imageNameArray
{
    ...
    _leftImageView.image =  [[UIImage imageWithFileName:_imageNameArray[0]]
                             resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
//    _centerImageView.image = [UIImage imageNamed:_imageNameArray[1]];
    _centerImageView.image =  [[UIImage imageWithFileName:_imageNameArray[1]]
                             resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
//    _rightImageView.image = [UIImage imageNamed:_imageNameArray[2]];
    _rightImageView.image =  [[UIImage imageWithFileName:_imageNameArray[2]]
                             resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
}
...
//    _leftImageView.image = [UIImage imageNamed:_imageNameArray[(currentImage-1)%_imageNameArray.count]];
  _leftImageView.image =  [[UIImage imageWithFileName:_imageNameArray[(currentImage-1)%_imageNameArray.count]]
resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    ...
    _centerImageView.image =  [[UIImage imageWithFileName:_imageNameArray[currentImage%_imageNameArray.count]]
                             resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
...
//    _rightImageView.image = [UIImage imageNamed:_imageNameArray[(currentImage+1)%_imageNameArray.count]];
    _rightImageView.image =  [[UIImage imageWithFileName:_imageNameArray[(currentImage+1)%_imageNameArray.count]]
                               resizeImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
